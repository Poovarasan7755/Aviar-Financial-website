            ...
            <div className="row">
              ...
              >
                ...
                <div className="d-flex justify-content-center justify-content-lg-start mb-3">
                  <a href="https://aviarfs.my1003app.com" className="btn-get-started scrollto">
                    Get Started
                  </a>
            ...
            <div className="container" data-aos="fade-up">
              ...
              <div className="row p-0 ">
                ...
                <div className="col-lg-6 pt-4 pt-lg-0">
                  ...
                  <a href="/#/step-1" className="border px-3 py-2 btn-learn-more-homepage ">
                    Apply Now
                  </a>
              ...
              >
                <Card className="vission-card-home">
                  <div className="icon-box">
                    ...
                    <Card.Body>
                      <h3 className="text-center home-page-mission-color">
                  ...
                  <div className="icon-box">
                    ...
                    <Card.Body>
                      <h3 className="text-center">
                        <a href="/" className="home-page-mission-color">
                          Our Vision
                        </a>
                      </h3>
                      <p>
              ...
              <div className="row">
                ...
                >
                  <div className="icon-box">
                    ...
                    <h4>
                      <a href="">Home Investment Property</a>
                    </h4>
                    <p>

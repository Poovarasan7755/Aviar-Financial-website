    ...
    <div >
      ...
      <Container fluid>
          ...
          <Row style={{ justifyContent: "center", margin: "-1%" }}>
            ...
            >
              ...
              <Card.Body>
                ...
                <Card.Text className="text-center">
                  We provide loan for purchasing new property.
                </Card.Text>
            ...
            >
              ...
              <Card.Body>
                ...
                <Card.Text className="text-center">
                  We trade your old mortgage with a new one.
                </Card.Text>
                <div className="d-flex justify-content-center">
                  <Button variant="primary">Learn more</Button>
                </div>
            ...
            >
              ...
              <Card.Body>
                ...
                <Card.Text className="text-center">
                  We provide best loans for your construction purposes.
                </Card.Text>
                <div className="d-flex justify-content-center">
                  <Button variant="primary">Learn more</Button>
                </div>
        ...
        <div className="mt-4">
          ...
          <p>
            Getting a loan doesn’t have to be a complicated process filled with
            headaches and paperwork. At Team USA Mortgage, we’re not just
            committed to finding you the perfect loan, we’re committed to making
            sure that the whole process is 100% pain–and hassle–free. We can
            qualify you in five minutes with our loan-by-phone program.
          </p>
        </div>
        <Row
        ...
        >
          ...
          <Col className="branch-manager-style">
            <div className="">
              ...
              <p>
                {" "}
                <a href="vijay@aviartechservices.com">
        ...
        <div className="mt-4">
          ...
          <p>
            We have access to an endless pool of investors, so we can offer you
            more options with better rates and services than other mortgage
            providers. We are quick, efficient, friendly, and easy to talk to.
          ...
          <p>
            A strong and genuine belief in the “customers for life” principal of
            doing business is what fuels this company. Referrals from previous
            customers and local real estate professionals have always delivered
            the majority of the company’s production. We believe in doing the
            job right the first time so our customers feel comfortable calling
            on us the next time.
          </p>
          <div className="d-flex justify-content-center">
            <img src={images} className="width-images mb-4 mt-4" />
          </div>
          <h5 style={{ color: "rgb(0 113 174)" }}>
            Low rates and fees through knowledge and technology
          </h5>

          <p>
            We use the most advanced technology available to close loans
            quickly, and at low cost. Team USA Mortgage combines the use of the
            internet along with advanced processing software and automated
            underwriting systems to find the best loan program for our
            customers. We’ve essentially taken the mystery out of approving and
            closing a home loan.
          </p>
          <h5 className="mt-4" style={{ color: "rgb(0 113 174)" }}>
          ...
          <p>
            Team USA Mortgage is dedicated in the pursuit of offering
            ...
            problems in the past with the opportunity to obtain a mortgage. Just
            ask about our low down payment purchase and FHA programs.
          </p>
          <h5 className="mt-4" style={{ color: "rgb(0 113 174)" }}>
            We Listen… then find the best loan product for you!
          </h5>
          <p>
            Our goal in serving our customers is letting them tell us what they
            wish to accomplish in the best possible scenario. Then we work hard
            to make that scenario a reality. We are proud of our commitment to
            get the job done right the first time. In times of uncertainty you
            want a mortgage company that will fight for your best interest. At
            Team USA Mortgage, we are committed to doing what’s best for our
        ...
        >
          ...
          <p className="px-4" style={{ color: "white" }}>
            Established in 2015 and headquartered in Bloomington, Illinois, we
            specialize in a broad range of IT consulting and staffing solutions.
            Our solutions can be tailored to match our clients’ needs while
            maintaining the flexibility to adapt to dynamic market and business
            requirements. We have been providing our services to Corporate and
            small business clients with remarkable results.
          </p>
          <p className="px-4" style={{ color: "white" }}>
            AVIAR Technology Services help our clients derive greater business
            value through better management of technology. We are committed to
            delivering excellence in creating innovative and flexible solutions
            for our clients.
          </p>
        </div>
        ...
        <Row className="mt-4">
          ...
          <Col xs={12} md={6} className="d-flex align-items-center mt-4 ">
            <div>
              <h3 style={{ color: "#0d81d4" }}>
                Check your Credit Score in just 1 minute.
              </h3>
              <p>

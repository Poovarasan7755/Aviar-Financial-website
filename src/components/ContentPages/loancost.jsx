    ...
    <div>
      <div>
        ...
        <Container fluid style={{ width: "90%" }}>
          ...
          <h5 style={{ color: "rgb(0 155 223)" }}>Points (optional)</h5>
          <p className="para">
          ...
          <h5 style={{ color: "rgb(0 155 223)" }}>Appraisal Fee</h5>
          <p className="para">
          ...
          <h5 style={{ color: "rgb(0 155 223)" }}>Credit Report</h5>
          <p className="para">
          ...
          <h5 style={{ color: "rgb(0 155 223)" }}>Interest Payment</h5>
          <p className="para">
          ...
          <h5 style={{ color: "rgb(0 155 223)" }}>Escrow Account</h5>
          <p className="para">
